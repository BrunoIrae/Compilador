...
public class CompiladorL3 {
	...
	public static void main(String[] args) throws ExceptionToken {
		...
		//Lexico lexico = new Lexico("compilador-main\\CompiladorL3\\src\\compiladorl3\\codigo.txt"); // IDE Eclipse
		Lexico lexico = new Lexico("src\\compiladorl3\\codigo.txt"); //IDE Netbeans
		//Lexico lexico = new Lexico( "src//compiladorl3//codigo.txt"); //VSCode
